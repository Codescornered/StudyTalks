			...
			<div className="h-screen flex items-center">
				<div className="max-w-xs mx-auto grow -mt-24">
					...
					<Card noPadding={true}>
						...
						<Link
							href="/"
							className="flex gap-3 items-center justify-center p-4 border-b border-b-gray-200 hover:bg-socialYellow hover:text-white hover:border-none hover:scale-110 transition-all hover:rounded-md"
						>
							<svg
								className="h-8 fill-current"
								xmlns="http://www.w3.org/2000/svg"
