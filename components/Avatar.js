...
import PreloaderTwo from "./preloader2";
	...
	return (
		<div className={`${width} relative`}>
			<div className="rounded-full overflow-hidden">
				<img src={url} alt="" className={`${height} w-full`} />
			</div>
			{isUploading && (
			...
			{editable && (
				<label className="absolute bottom-0 right-0 shadow-md shadow-gray-500 p-2 bg-socialYellow rounded-full cursor-pointer">
					<input
						type="file"
						className="hidden"
